...
class CountryDetail extends Component {
    ...
    render() {
        ...
        console.log(this.state.contryDataToDisplay);

        return (
            
            <div className="card padding-medium" >
                {this.state.showWaitSpinner || this.state.contryDataToDisplay === undefined ?
                    ...
                    :
                    <div> 
                        <h1>{ this.state.contryDataToDisplay.name }</h1>
                        <div className="row">
                            <div className="small-2 columns">
                                Capital: 
                            </div>
                            <div className="small-10 columns">
                                { this.state.contryDataToDisplay.capital }
                            </div>
                        </div>
                        <div className="row">
                            <div className="small-2 columns">
                            ...
                            <div className="small-10 columns">
                                ...
                                { this.state.contryDataToDisplay.currencies.map(this.mapCurrencies) }
                            </div>
                        </div>
                        <div className="row">
                            <div className="small-2 columns">
                            ...
                            <div className="small-10 columns">
                                { this.state.contryDataToDisplay.languages.map(this.mapLanguages) }
                            </div>
                        </div>
                        <div className="row">
                            <div className="small-2 columns">
                            ...
                            <div className="small-10 columns">
                                { this.state.contryDataToDisplay.population.toLocaleString() }
                            </div>
                        </div>
                        <div className="row">
                            <div className="small-2 columns">
                            ...
                            <div className="small-10 columns">
                                <img alt={this.state.contryDataToDisplay.name + " flag"} src={this.state.contryDataToDisplay.flag} height="300" width="510" border="1"/>
                            </div>
                        </div>
                    </div>
                }
